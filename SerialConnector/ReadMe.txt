========================================================================
    ダイナミック リンク ライブラリ: SerialConnector 
    プロジェクトの概要
========================================================================

この SerialConnector DLL は、AppWizard により作成されました。  

このファイルには、SerialConnector 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

SerialConnector.vcxproj
...
SerialConnector.vcxproj.filters
